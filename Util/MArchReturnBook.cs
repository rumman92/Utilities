...
namespace Utility
{
    public partial class MArchReturnBook : Form
    {
        ...
        private void refund()
        {
            try
            {
                ...
                string query = string.Format("select [Number of Copies] from MArchDetails where [ID Number]='{0}'", textBox1.Text);
                ...
                string update = string.Format("update MArchDetails set [Number of Copies]={0} where [ID Number]='{1}'", number, textBox1.Text);
                da.UpdateCommand = new SqlCommand(update, con);
                da.UpdateCommand.ExecuteNonQuery();

                string del = string.Format("delete from MArchIssueConfirm where [Card Number]='{0}'", textBox2.Text);
        ...
        private void MArchReturnBook_Load(object sender, EventArgs e)
        {

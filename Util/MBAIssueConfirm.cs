...
namespace Utility
{
    public partial class MBAIssueConfirm : Form
    {
        ...
        public MBAIssueConfirm()
        {
            InitializeComponent();
        }

        public MBAIssueConfirm(string id, string sstream)
        {
            InitializeComponent();
            textBox3.Text = id;
        ...
        private void MBAIssueConfirm_Load(object sender, EventArgs e)
        {

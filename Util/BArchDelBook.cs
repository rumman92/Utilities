...
namespace Utility
{
    public partial class BArchDelBook : Form
    {
        ...
        private void remove()
        {
            try
            {
                ...
                string del = string.Format("delete from BArchDetails where [ID Number] ='{0}'", textBox1.Text);
        ...
        private void BArchDelBook_Load(object sender, EventArgs e)
        {

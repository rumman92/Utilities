...
namespace Utility
{
    public partial class MArchDelBook : Form
    {
        ...
        private void remove()
        {
            try
            {
                ...
                string del = string.Format("delete from MArchDetails where [ID Number] ='{0}'", textBox1.Text);
        ...
        private void MArchDelBook_Load(object sender, EventArgs e)
        {

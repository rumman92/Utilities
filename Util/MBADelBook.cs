...
namespace Utility
{
    public partial class MBADelBook : Form
    {
        ...
        private void remove()
        {
            try
            {
                ...
                string del = string.Format("delete from MBADetails where [ID Number] ='{0}'", textBox1.Text);
        ...
        private void MBADelBook_Load(object sender, EventArgs e)
        {

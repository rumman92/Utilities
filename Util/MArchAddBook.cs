...
namespace Utility
{
    public partial class MArchAddBook : Form
    {
        ...
        private void append()
        {
            try
            {
                ...
                string query = string.Format("insert into MArchDetails values('{0}','{1}','{2}','{3}','{4}','{5}')", textBox1.Text, textBox2.Text, textBox3.Text, textBox4.Text, textBox5.Text, Convert.ToInt32(textBox6.Text));
        ...
        private void MArchAddBook_Load(object sender, EventArgs e)
        {

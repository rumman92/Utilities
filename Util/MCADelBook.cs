...
namespace Utility
{
    public partial class MCADelBook : Form
    {
        ...
        private void remove()
        {
            try
            {
                ...
                string del = string.Format("delete from MCADetails where [ID Number] ='{0}'", textBox1.Text);
        ...
        private void MCADelBook_Load(object sender, EventArgs e)
        {

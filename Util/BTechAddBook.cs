...
namespace Utility
{
    public partial class BTechAddBook : Form
    {
        ...
        private void append()
        {
            try
            {
                ...
                string query = string.Format("insert into BTechDetails values('{0}','{1}','{2}','{3}','{4}','{5}','{6}')", textBox1.Text, textBox2.Text, textBox3.Text, textBox4.Text, textBox5.Text, Convert.ToInt32(textBox6.Text), comboBox1.Text);
        ...
        private void BTechAddBook_Load(object sender, EventArgs e)
        {

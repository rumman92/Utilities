...
namespace Utility
{
    public partial class MCAIssue : Form
    {
        ...
        private void MCAIssue_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void confirm()
        {
            ...
            {
                MCAIssueConfirm mcaissueconfirm = new MCAIssueConfirm(textBox3.Text, comboBox1.Text);
                mcaissueconfirm.Show();
            }
            else
            {
